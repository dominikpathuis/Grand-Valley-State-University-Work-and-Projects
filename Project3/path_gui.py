...
class GUI:
    def __init__(self):
        ...
        for i in range(random.randint(4, 20)):
            ...
            for j in range(cols):
                ...
                # grass represents land and ocean represents the block
        ...
        self._screen = pg.display.set_mode((self.max_width * IMAGE_SIZE + IMAGE_SIZE * 2, self.max_height * IMAGE_SIZE +
                                            IMAGE_SIZE * 2))
        # Sets the heading
    ...
    def get_end_point(self):
        ...
        while self._start_point == self._end_point or self.actual_board[self._end_point[0]][
            self._end_point[1]] == 'ocean':
            end_row = random.randint(0, height - 1)
    ...
    def run_game_on_board(self):
        ...
        for pos in lst_path:
            ...
            if len(prev) != 0:
                self._screen.blit(IMAGES[prev[2]],
                                  pg.Rect(prev[1] * IMAGE_SIZE, prev[0] * IMAGE_SIZE, IMAGE_SIZE, IMAGE_SIZE))
                pg.display.flip()
